...
console.log(createMenuItem('sushi', 15, 'lunch'));
console.log(createMenuItem('steak & eggs', 25, 'brunch'));
...
reviews.push({
	...
	rating: 4.0,
	feedback:
		'Attentive service, excellent cuisine! But the decor leaves something to be desired. I give this place...2 stars. Unsubscribe.'
});
console.log(reviews);
...
function getLastReview(objArr) {
	let last = objArr[objArr.length - 1];
